...
import numpy as np
import sys
from functions_for_GP_analysis.GPproperties import tuple_to_binary_string, LZ_complexity_array
import pandas as pd
...
def LZ_complexity_from_tuple_notation(tuple_ph, resolution):
   return LZ_complexity_array(tuple_to_binary_string(tuple_ph, resolution))
...
####################################################################################
filename_complexitydata = './biomorphs_map_pixels/arraycomplexitydata'+string_for_saving_plot+'.csv'
parallel_function = partial(LZ_complexity_from_tuple_notation, resolution=resolution)
